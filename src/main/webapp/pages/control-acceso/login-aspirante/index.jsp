...
<body>
	...
	<div class="col-sm-12">
		<s:form id="frmLogin" method="post" theme="simple"
			...
			action="%{#pageContext.request.contextPath}/control-acceso/login-aspirante">
			...
			<div class="form-group center">
				<div class="row">
					...
					<!-- <div class="col-md-12 center">
						<a class="liga"
							href="${pageContext.request.contextPath}/control-acceso/registrar-aspirante/new"><s:text
								name="IU1.3-1_LBL4" /></a>
					</div> - -->
				</div>
			</div>
